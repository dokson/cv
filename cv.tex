...
\namesection{Alessandro}{Colace}{ 
    \faEnvelope\hspace{2pt} \href{mailto:ale@colace.me} {ale@colace.me}
    \hspace{4pt}
    \faPhone\hspace{2pt} \href{tel:+393495157235}{349 5157235}
    \hspace{4pt}
    \faLinkedin\hspace{2pt} \href{https://linkedin.com/in/colace}{colace}
    \hspace{4pt}
    \faGithub\hspace{2pt} \href{https://github.com/dokson}{dokson}
    \hspace{4pt}
    \faCircleUser\hspace{2pt} \href{https://www.colace.me/}{colace.me}
    \hspace{4pt}
    \faC\hspace{2pt} \href{https://www.coalesce.coach}{coalesce.coach}
    %\hspace{4pt}
